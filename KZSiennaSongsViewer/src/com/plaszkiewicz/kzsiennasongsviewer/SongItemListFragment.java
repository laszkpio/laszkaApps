...
public class SongItemListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<SongsContent.SongItem>(getActivity(),
				layout,
				android.R.id.text1, SongsContent.ITEMS));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		SongsContent.SongItem mItem = (SongsContent.SongItem) this.getListAdapter().getItem(position);
